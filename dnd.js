var dnd = {
	...
	"rangerenemy":[
		{"key":"aberrations", "name":"Aberrations", "summary":"Aberrations are utterly alien beings."},
		{"key":"beasts", "name":"Beasts", "summary":"Beasts are a natural part of the fantasy ecology."},
		{"key":"celestials", "name":"Celestials", "summary":"Celestials are creatures native to the Upper Planes."},
		{"key":"constructs", "name":"Constructs", "summary":"Constructs are made, not born."},
		{"key":"dragons", "name":"Dragons", "summary":"Dragons are large reptilian creatures of tremendous power."},
		{"key":"elementals", "name":"Elementals", "summary":"Elementals are creatures native to the elemental planes."},
		{"key":"fey", "name":"Fey", "summary":"Fey are magical creatures closely tied to the forces of nature."},
		{"key":"fiends", "name":"Fiends", "summary":"Fiends are creatures native to the Lower Planes."},
		{"key":"giants", "name":"Giants", "summary":"Giants tower over humans and their kind. They are humanlike in shape."},
		{"key":"humanoid", "name":"Humanoid", "summary":"Humanoids are the main peoples of the world, both civilized and savage."},
		{"key":"monstrosities", "name":"Monstrosities", "summary":"Monstrosities are monsters in the strictest sense."},
		{"key":"oozes", "name":"Oozes", "summary":"Oozes are gelatinous creatures that rarely have a fixed shape."},
		{"key":"plants", "name":"Plants", "summary":"Plants in this context are vegetable creatures, not ordinary flora."},
	...
	"archetypes":[{
		...
		"spells_template":"<ol><li value=1>____</li><li value=3>____</li><li value=5>____</li><li value=7>____</li><li value=9>____</li></ol>",
		"key":"knowledge",
		...
		"features":[
			...
			{"level":1, "key":"TODO", "name":"Arcane Initiate", "summary":"TODO", "description":"When you choose this domain at 1st level, you gain proficiency in the Arcana skill, and you gain two cantrips of your choice from the wizard spell list. For you, these cantrips count as cleric cantrips."},
			{"level":2, "key":"TODO", "name":"Channel Divinity: Arcane Abjuration", "summary":"TODO", "description":"TODO"},
			{"level":6, "key":"TODO", "name":"Spell Breaker", "summary":"TODO", "description":"Starting at 6th level, when you restore hit points to an ally with a spell of 1st level or higher, you can also end one spell of your choice on that creature. The level of the spell you end must be equal to or lower than the level of the spell slot you use to cast the healing spell."},
			{"level":8, "key":"TODO", "name":"Potent Spellcasting", "summary":"TODO", "description":"Starting at 8th level, you add your Wisdom modifier to the damage you deal with any cleric cantrip."},
			{"level":17, "key":"TODO", "name":"Arcane Mastery", "summary":"TODO", "description":"At 17th level, you choose four spells from the wizard spell list, one from each of the following levels: 6th, 7th, 8th, and 9th. You add them to your list of domain spells. Like your other domain spells, they are always prepared and count as cleric spells for you."},
		]
	},{
		"key":"forge",
		"name":"Forge Domain",
		...
		"features":[
			...
			{"level":1, "key":"TODO", "name":"Bonus Proficiencies", "summary":"TODO", "description":"When you choose this domain at 1st level, you gain proficiency with heavy armor and smith's tools."},
			{"level":1, "key":"TODO", "name":"Blessing of the Forge", "summary":"TODO", "description":"At 1st level, you gain the ability to imbue magic into a weapon or armor. At the end of a long rest, you can touch one nonmagical object that is a suit of armor or a simple or martial weapon. Until the end of your next long rest or until you die, the object becomes a magic item, granting a +1 bonus to AC if it’s armor or a +1 bonus to attack and damage rolls if it’s a weapon.<br/>Once you use this feature, you can’t use it again until you finish a long rest."},
			{"level":2, "key":"TODO", "name":"Channel Divinity: Artisan's Blessing", "summary":"TODO", "description":"Starting at 2nd level, you can use your Channel Divinity to create simple items.<br/>You conduct an hour-long ritual that crafts a nonmagical item that must include some metal: a simple or martial weapon, a suit of armor, ten pieces of ammunition, a set of tools, or another metal object. The creation is completed at the end of the hour, coalescing in an unoccupied space of your choice on a surface within 5 feet of you.<br/>The thing you create can be something that is worth no more than 100 gp. As part of this ritual, you must lay out metal, which can include coins, with a value equal to the creation. The metal irretrievably coalesces and transforms into the creation at the ritual’s end, magically forming even nonmetal parts of the creation.<br/>The ritual can create a duplicate of a nonmagical item that contains metal, such as a key, if you possess the original during the ritual."},
			{"level":6, "key":"TODO", "name":"Soul of the Forge", "summary":"TODO", "description":"Starting at 6th level, your mastery of the forge grants you special abilities:<ul><li>You gain resistance to fire damage.</li><li>While wearing heavy armor, you gain a +1 bonus to AC.</li></ul>"},
			{"level":8, "key":"TODO", "name":"Divine Strike", "summary":"TODO", "description":"At 8th level, you gain the ability to infuse your weapon strikes with the fiery power of the forge. Once on each of your turns when you hit a creature with a weapon attack, you can cause the attack to deal an extra 1d8 fire damage to the target. When you reach 14th level, the extra damage increases to 2d8."},
			{"level":17, "key":"TODO", "name":"Saint of Forge and Fire", "summary":"TODO", "description":"At 17th level, your blessed affinity with fire and metal becomes more powerful:<ul><li>You gain immunity to fire damage.</li><li>While wearing heavy armor, you have resistance to bludgeoning, piercing, and slashing damage from nonmagical attacks.</li></ul>"},
		]
	},{
		"key":"grave",
		"name":"Grave Domain",
		...
		"features":[
			...
			{"level":1, "key":"TODO", "name":"Circle of Mortality", "summary":"TODO", "description":"At 1st level, you gain the ability to manipulate the line between life and death. When you would normally roll one or more dice to restore hit points with a spell to a creature at 0 hit points, you instead use the highest number possible for each die.<br/>In addition, you learn the Spare the Dying cantrip, which doesn't count against the number of cleric cantrips you know. For you, it has a range of 30 feet, and you can cast it as a bonus action."},
			{"level":1, "key":"TODO", "name":"Eyes of the Grave", "summary":"TODO", "description":"At 1st level, you gain the ability to occasionally sense the presence of the undead, whose existence is an insult to the natural cycle of life. As an action, you can open your awareness to magically detect undead. Until the end of your next turn, you know the location of any undead within 60 feet of you that isn't behind total cover and that isn't protected from divination magic. This sense doesn't tell you anything about a creature's capabilities or identity.<br/>You can use this feature a number of times equal to your Wisdom modifier (minimum of once). You regain all expended uses when you finish a long rest."},
			{"level":2, "key":"TODO", "name":"Channel Divinity: Path to the Grave", "summary":"TODO", "description":"Starting at 2nd level, you can use your Channel Divinity to mark another creature’s life force for termination.<br/>As an action, you choose one creature you can see within 30 feet of you, cursing it until the end of your next turn. The next time you or an ally of yours hits the cursed creature with an attack, the creature has vulnerability to all of that attack's damage, and then the curse ends."},
			{"level":6, "key":"TODO", "name":"Sentinel at Death's Door", "summary":"TODO", "description":"At 6th level, you gain the ability to impede death’s progress. As a reaction when you or an ally that you can see within 30 feet of you suffers a critical hit, you can turn that attack into a normal hit. Any effects triggered by a critical hit are canceled.<br/>You can use this feature a number of times equal to your Wisdom modifier (minimum of once). You regain all expended uses when you finish a long rest."},
			{"level":8, "key":"TODO", "name":"Potent Spellcasting", "summary":"TODO", "description":"Starting at 8th level, you add your Wisdom modifier to the damage you deal with any cleric cantrip."},
			{"level":17, "key":"TODO", "name":"Keeper of Souls", "summary":"TODO", "description":"At 17th level, you can seize a trace of vitality from a parting soul and use it to heal the living. When an enemy you can see dies within 30 feet of you, you or one ally of your choice that is within 30 feet of you regains hit points equal to the enemy’s number of Hit Dice. You can use this feature only if you aren't incapacitated. Once you use it, you can't do so again until the start of your next turn."},
		]
	},{
		"key":"land",
