var spells = [
	{
		...
		"ritual": true,
		"defense": true,
		"classes": ["Ranger", "Ritualist", "Wizard"],
		...
		"ritual": true,
		"classes": ["Cleric", "Paladin"],
		"desc": "<p>You perform a special religious ceremony that is infused with magic. When you cast the spell, choose one of the following rites, the target of which must be within 10 feet of you throughout the casting.</p><p>Atonement. You touch one willing creature whose alignment has changed, and you make a DC 20 Wisdom (Insight) check. On a successful check, you restore the target to its original alignment.</p><p>Bless Water. You touch one vial of water and cause it to become holy water.</p><p>Coming of Age. You touch one humanoid who is a young adult. For the next 24 hours, whenever the target makes an ability check, it can roll a d4 and add the number rolled to the ability check. A creature can benefit from this rite only once.</p><p>Dedication. You touch one humanoid who wishes to be dedicated to your god’s service. For the next 24 hours, whenever the target makes a saving throw, it can roll a d4 and add the number rolled to the save. A creature can benefit from this rite only once.</p><p>Funeral Rite. You touch one corpse, and for the next 7 days, the target can’t become undead by any means short of a wish spell.</p><p>Wedding. You touch adult humanoids willing to be bonded together in marriage. For the next 7 days, each target gains a +2 bonus to AC while they are within 30 feet of each other. A creature can benefit from this rite again only if widowed.</p>",
		"book": "xgte",
		"page": 151
	},{
		"key": "chainlightning",
		...
		"damage_type": "*",
		"classes": ["Sorcerer"],
		"desc": "<p>You hurl an undulating, warbling mass of chaotic energy at one creature in range. Make a ranged spell attack against the target. On a hit, the target takes 2d8 + 1d6 damage. Choose one of the d8s. The number rolled on that die determines the attacks damage type, as shown below.</p><p>d8 / Damage Type</p><p>1 / Acid</p><p>2 / Cold</p><p>3 / Fire</p><p>4 / Force</p><p>5 / Lightning</p><p>6 / Poison</p><p>7 / Psychic</p><p>8 / Thunder</p><p>If you roll the same number on both d8s, the chaotic energy leaps from the target to a different creature of your choice within 30 feet of it. Make a new attack roll against the new target, and make a new damage roll, which could cause the chaotic energy to leap again. A creature can be targeted only once by each casting of this spell.</p>",
		...
		"duration": "1 hour",
		"ritual": true,
		"classes": ["Bard", "Ritualist", "Sorcerer", "Warlock", "Wizard"],
		...
		"concentration": true,
		"classes": ["Cleric"],
		"desc": "<p>You summon a celestial of challenge rating 4 or lower (e.g. Couatl, Pegasus), which appears in an unoccupied space that you can see within range. The celestial disappears when it drops to 0 hit points or when the spell ends.</p><p>The celestial is friendly to you and your companions for the duration. Roll initiative for the celestial, which has its own turns. It obeys any verbal commands that you issue to it (no action required by you), as long as they don’t violate its alignment. If you don’t issue any commands to the celestial, it defends itself from hostile creatures but otherwise takes no actions.</p><p>The DM has the celestial’s statistics.</p>",
		"higher_level": "<p>When you cast this spell using a 9th-level spell slot, you summon a celestial of challenge rating 5 or lower (e.g. Unicorn).</p>",
		"book": "phb",
		"page": 225
	},{
		"key": "conjureelemental",
		...
		"desc": "<p>You summon a fey creature of challenge rating 6 or lower (e.g. Green Hag), or a fey spirit that takes the form of a beast of challenge rating 6 or lower (e.g. Mammoth). It appears in an unoccupied space that you can see within range. The fey creature disappears when it drops to 0 hit points or when the spell ends.</p><p>The fey creature is friendly to you and your companions for the duration. Roll initiative for the creature, which has its own turns. It obeys any verbal commands that you issue to it (no action required by you), as long as they don’t violate its alignment. If you don’t issue any commands to the fey creature, it defends itself from hostile creatures but otherwise takes no actions.</p><p>If your concentration is broken, the fey creature doesn’t disappear. Instead, you lose control of the fey creature, it becomes hostile toward you and your companions, and it might attack. An uncontrolled fey creature can’t be dismissed by you, and it disappears 1 hour after you summoned it.</p><p>The DM has the fey creature’s statistics.</p>",
		"higher_level": "<p>When you cast this spell using a spell slot of 7th level or higher, the challenge rating increases by 1 for each slot level above 6th (e.g. Giant Ape).</p>",
		"book": "phb",
		"page": 226
	},{
		"key": "conjureminorelementals",
		...
		"concentration": true,
		"classes": ["Druid", "Wizard"],
		"desc": "<p>You summon elementals that appear in unoccupied spaces that you can see within range. You choose one the following options for what appears:</p><p>• One elemental of challenge rating 2 or lower (e.g. Azer, Gargoyle)</p><p>• Two elementals of challenge rating 1 or lower (e.g. Fire Snake)</p><p>• Four elementals of challenge rating 1/2 or lower (e.g. Magmin, Mephit)</p><p>• Eight elementals of challenge rating 1/4 or lower. (e.g. Mephit)</p><p>An elemental summoned by this spell disappears when it drops to 0 hit points or when the spell ends.</p><p>The summoned creatures are friendly to you and your companions. Roll initiative for the summoned creatures as a group, which has its own turns. They obey any verbal commands that you issue to them (no action required by you). If you don’t issue any commands to them, they defend themselves from hostile creatures, but otherwise take no actions.</p><p>The DM has the creatures’ statistics.</p>",
		...
		"concentration": true,
		"classes": ["Druid", "Ranger"],
		"desc": "<p>You summon fey creatures that appear in unoccupied spaces that you can see within range. Choose one of the following options for what appears:</p><p>• One fey creature of challenge rating 2 or lower (e.g. Sea Hag)</p><p>• Two fey creatures of challenge rating 1 or lower (e.g. Dryad)</p><p>• Four fey creatures of challenge rating 1/2 or lower (e.g. Satyr)</p><p>• Eight fey creatures of challenge rating 1/4 or lower (e.g. Pixie, Sprite)</p><p>A summoned creature disappears when it drops to 0 hit points or when the spell ends.</p><p>The summoned creatures are friendly to you and your companions. Roll initiative for the summoned creatures as a group, which have their own turns. They obey any verbal commands that you issue to them (no action required by you). If you don’t issue any commands to them, they defend themselves from hostile creatures, but otherwise take no actions.</p><p>The DM has the creatures’ statistics.</p>",
		"higher_level": "<p>When you cast this spell using certain higher-level spell slots, you choose one of the summoning options above, and more creatures appear: twice as many with a 6th-level slot and three times as many with an 8th-level slot.</p>",
		"book": "phb",
		"page": 226
	},{
		"key": "contactotherplane",
		...
		"duration": "1 minute",
		"ritual": true,
		"classes": ["Ritualist", "Warlock", "Wizard"],
		...
		"defense": true,
		"classes": ["Sorcerer", "Warlock", "Wizard"],
		"desc": "<p>Cast as a reaction when you see a creature within 60 feet of you casting a spell.<p><p>You attempt to interrupt a creature in the process of casting a spell. If the creature is casting a spell of 3rd level or lower, its spell fails and has no effect. If it is casting a spell of 4th level or higher, make an ability check using your spellcasting ability. The DC equals 10 + the spell’s level. On a success, the creature’s spell fails and has no effect.</p>",
		...
		"ritual": true,
		"concentration": true,
		"classes": ["Bard", "Cleric", "Druid", "Paladin", "Ranger", "Ritualist", "Sorcerer", "Wizard"],
		...
		"ritual": true,
		"concentration": true,
		"classes": ["Cleric", "Druid", "Paladin", "Ranger", "Ritualist"],
		...
		"duration": "Instantaneous",
		"classes": ["Cleric"],
		"desc": "<p>You utter a divine word, imbued with the power that shaped the world at the dawn of creation.</p><p>Choose any number of creatures you can see within range. Each creature that can hear you must make a Charisma saving throw. On a failed save, a creature suffers an effect based on its current hit points</p><p>• 50 hit points or fewer: deafened for 1 minute</p><p>• 40 hit points or fewer: deafened and blinded for 10 minutes</p><p>• 30 hit points or fewer: blinded, deafened, and stunned for 1 hour</p><p>• 20 hit points or fewer: killed instantly</p><p>Regardless of its current hit points, a celestial, an elemental, a fey, or a fiend that fails its save is forced back to its plane of origin (if it isn’t there already) and can’t return to your current plane for 24 hours by any means short of a wish spell.</p>",
		"book": "phb",
		"page": 234
	},{
		"key": "dominatebeast",
		...
		"duration": "1 minute",
		"classes": ["Bard", "Sorcerer", "Wizard"],
		"desc": "<p>Cast as a reaction when you or a creature within 60 feet of you falls.<p><p>Choose up to five falling creatures within range. A falling creature’s rate of descent slows to 60 feet per round until the spell ends. If the creature lands before the spell ends, it takes no falling damage and can land on its feet, and the spell ends for that creature.</p>",
		"book": "phb",
		"page": 239
	},{
		"key": "feeblemind",
		...
		"duration": "1 hour",
		"ritual": true,
		"classes": ["Bard", "Cleric", "Druid", "Ritualist", "Wizard"],
		...
		"duration": "10 days",
		"ritual": true,
		"classes": ["Cleric", "Ritualist", "Wizard"],
		...
		"damage_type": "*",
		"classes": ["Bard", "Cleric", "Wizard"],
		"desc": "<p>When you cast this spell, you inscribe a glyph that harms other creatures, either upon a surface (such as a table or a section of floor or wall) or within an object that can be closed (such as a book, a parchment, or a chest) to conceal the glyph. If you choose a surface, the glyph can cover an area of the surface no larger than 10 feet in diameter. If you choose an object, that object must remain in place; if the object is moved more than 10 feet from where you cast this spell, the glyph is broken, and the spell ends without being triggered.</p><p>The glyph is nearly invisible and requires a successful Intelligence (Investigation) check against your spell save DC to be found.</p><p>You decide what triggers the glyph when you cast the spell. For glyphs inscribed on a surface, the most typical triggers include touching or standing on the glyph, removing another object covering the glyph, approaching within a certain distance of the glyph, or manipulating the object on which the glyph is inscribed. For glyphs inscribed within an object, the most common triggers include opening that object, approaching within a certain distance of the object, or seeing or reading the glyph. Once a glyph is triggered, this spell ends.</p><p>You can further refine the trigger so the spell activates only under certain circumstances or according to physical characteristics (such as height or weight), creature kind (for example, the ward could be set to affect abberations or drow), or alignment. You can also set conditions for creatures that do not trigger the glyph, such as those who say a certain password.</p><p>When you inscribe the glyph, choose <i>explosive runes</i> or a <i>spell glyph</i>.</p><p><b>Explosive runes.</b> When triggered, the glyph erupts with magical energy in a 20-foot-radius sphere centered on the glyph. The sphere spreads around corners. Each creature in the area must make a Dexterity saving throw. A creature takes 5d8 acid, cold, fire, lightning, or thunder damage on a failed saving throw (your choice when you create the glyph), or half as much damage on a successful one.</p><p><b>Spell glyph.</b> You can store a prepared spell of 3rd level or lower in the glyph by casting it as part of creating the glyph. The spell must target a single creature or an area. The spell being stored has no immediate effect when cast in this way. When the glyph is triggered, the stored spell is cast. If the spell hass a target, it targets the creature that triggered the glyph. If the spell affects an area, the area is centered on that creature. If the spell summons hostile creatures or creates harmful objects or traps, they also appear as close as possible to the intruder and attack it. If the spell requires concentration, it lasts until the end of its full duration.</p>",
		"higher_level": "<p>When you cast this spell using a spell slot of 4th level or higher, the damage of an <i>explosive runes</i> increases by 1d8 for each slot level of above 3rd. If you create a <i>spell glyph</i>, you can store any spell up to the same lavel as the slot used to cast the glyph.</p>",
		"book": "phb",
		"page": 245
	},{
		"key": "goodberry",
		...
		"damage_type": "fire",
		"classes": ["Warlock"],
		"desc": "<p>Cast as a reaction to being damaged by a creature within 60 feet of you that you can see.</p><p>You point your finger, and the creature that damaged you is momentarily surrounded by hellish flames. The creature must make a dexterity saving throw. It takes 2d10 fire damage on a failed save, or half as much damage on a successful one.</p>",
		...
		"damage_type": "radiant",
		"classes": ["Cleric", "Paladin"],
		"desc": "<p>You imbue a weapon you touch with holy power. Until the spell ends, the weapon emits bright light in a 30-foot radius and dim light for an additional 30 feet. In addition, weapon attacks made with it deal an extra 2d8 radiant damage on a hit. If the weapon isn’t already a magic weapon, it becomes one for the duration. As a bonus action on your turn, you can dismiss this spell and cause the weapon to emit a burst of radiance. Each creature of your choice that you can see within 30 feet of you must make a Constitution saving throw. On a failed save, a creature takes 4d8 radiant damage, and it is blinded for 1 minute. On a successful save, a creature takes half as much damage and isn’t blinded. At the end of each Ofits turns, a blinded creature can make a Constitution saving throw, ending the effect on itselfon a success.</p>",
		"book": "xgte",
		"page": 157
	},{
		"key": "hungerofhadar",
		...
		"duration": "10 days",
		"ritual": true,
		"classes": ["Bard", "Ritualist", "Warlock", "Wizard"],
		...
		"components": ["V", "S"],
		"duration": "Instantaneous",
		"save": ["constitution", "dexterity", "wisdom"],
		"damage": "10d6",
		"damage_type": "*",
		"classes": ["Sorcerer", "Wizard"],
		...
		"duration": "Instantaneous",
		"ritual": true,
		"classes": ["Cleric", "Druid", "Paladin", "Ritualist"],
		...
		"defense": true,
		"classes": ["Sorcerer", "Wizard"],
		"desc": "<p>Cast as a reaction when you are hit by an attack or targeted by the <i>magic missile</i> spell.</p><p>An invisible barrier of magical force appears and protects you. Until the start of your next turn, you have a +5 bonus to AC, including against the triggering attack, and you take no damage from magic missile.</p>",
		"book": "phb",
		"page": 275
	},{
		"key": "shieldoffaith",
		...
		"ritual": true,
		"concentration": true,
		"classes": ["Bard", "Druid", "Ritualist", "Wizard"],
		...
		"higher_level": "<p>When you cast this spell using a spell slot of 5th level or higher, the challenge rating increases by 1 for each slot level above 4th (e.g. Vrock, Armanite, Hezrou, Glabrezu).</p>",
		"book": "xgte",
		"page": 166
	},{
		"key": "summonlesserdemons",
		...
		"duration": "Until dispelled",
		"classes": ["Wizard"],
		"desc": "<p>This spell name was added as an error and does not exist. Refer to “Imprisonment” for the real spell.</p>",
		"book": "phb",
		"page": 211
	},{
		"key": "treestride",
		...
		"duration": "24 hours",
		"ritual": true,
		"classes": ["Druid", "Ranger", "Ritualist", "Sorcerer", "Wizard"],
		...
		"duration": "1 hour",
		"ritual": true,
		"classes": ["Cleric", "Druid", "Ranger", "Ritualist", "Sorcerer"],
